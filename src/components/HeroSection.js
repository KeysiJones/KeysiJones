...
function HeroSection() {
  ...
  return (
    <div
      className='flex h-screen py-4 lg:items-center lg:px-40 lg:flex lg:flex-row'
      id='hero-section'
    >
      <div
        id='myinfo'
      ...
      >
        ...
        />
        <p className='mb-12 text-center text-white text-7xl md:text-8xl lg:text-9xl'>
        ...
        <p className='mx-2 mt-2 text-2xl font-light text-center text-white lg:text-4xl'>
          by building <span className='text-yellow-400'>fullstack</span> apps
        </p>
        {/* <button className='p-4 m-auto mt-10 text-2xl bg-yellow-400 hero rounded-xl'>
          Get in touch now
        </button> */}
